...
public abstract class AbstractClient<T extends AbstractClient<T>> {
    ...
    public final  <R>  R sendPacket(Packet packet, CallablePacketListener<T,R> callablePacketListener, long timeout) {
    ...
    abstract class SecondaryPacketListener<C extends AbstractClient>{
